...
> [!WARNING]
> This is a **fork** of [ArmchairDevelopers/Maxima](https://github.com/ArmchairDevelopers/Maxima) maintained exclusively for [Draconis](https://github.com/AA-EION/Draconis). If you're not using Draconis, use the upstream repo instead.
